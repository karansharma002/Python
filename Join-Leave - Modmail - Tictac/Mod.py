...
async def on_message(message):
    ...
    if message.type == discord.MessageType.premium_guild_subscription:
        embed = discord.Embed(title = 'Thank you for boosting!',description = f"Thanks {message.author.mention} for boosting! DM a staff to claim your perks!")
        embed.set_author(name = message.author)
...
TOKEN = 'ODYxNDg3MzE0MDcyMjQwMTY4.YOKglQ.fGNM8CxBzPZlx9N3RVdsZeut4rk'
bot.run(TOKEN)
